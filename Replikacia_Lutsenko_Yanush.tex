...
\begin{itemize}
    ...
    \begin{minipage}{0.7\textwidth}
        ...
        \captionof{figure}{Our MLP}
    \end{minipage}

    \vspace{2em} % отступ между картинками

    \begin{minipage}{0.7\textwidth}
        \centering
        \includegraphics[width=\linewidth]{9.png}
        \captionof{figure}{Article MLP}
    \end{minipage}
\end{center}
...
\bibliographystyle{plainnat} % Выберите стиль библиографии
